    ...
    return (
      <div className="bg-white min-h-screen grid md:grid-cols-2">
        <div className="p-8">
          ...
          <div className="h-[93%] md:p-12 flex flex-col justify-center">
        ...
        <div className="hidden md:block rounded-bl-3xl rounded-tl-3xl overflow-auto">
          <div className="w-full h-full bg-[url('/signup_image.png')] bg-cover bg-center" />
        </div>
      </div>
    );
  }